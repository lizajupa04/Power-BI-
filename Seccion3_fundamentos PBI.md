...
- Para entrar al power query editor **Home >>> Transform data**
- Cuando entramos a transformación de datos, vamos a ver que se abre una ventana nueva, conformada por el panel superior de opciones, panel izquierdo de las consultas, panel del centro del conjunto de datos y panel de la derecha el de las configuraciones.
- En el panel derecho **"Configuraciones"**, vamos a ver los pasos que hemos aplicados de las transformaciones.
- En la barra de Fx, podemos ver un tipo de codigo llamado M. Cada vez que se haga la transformacion eso va ir cambiando.
